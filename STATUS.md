...
| # | Gate | Checks | Status |
|---|------|--------|--------|
| 1 | Backend end-to-end | 327 | passing |
| 2 | Google Sign-In (local IdP, no egress) | 23 | passing |
| 3 | Android ⇆ backend contract | 98 | passing |
| 4 | Web UI (real bundle in jsdom, real backend, no mocks) | 502 | passing |
...
**1,003 checks.** Every suite cleans up after itself; the database returns to 7
